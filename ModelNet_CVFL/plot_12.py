...
batch_size = 64
embedding_size = 4096
server_model_size = 491520
batches_per_epoch = 16
min_bits_per_epoch = batches_per_epoch*(2*embedding_size*batch_size*12**2 + server_model_size*12)*2
...
for t in types:
    ...
    # Parse results
    losses0 = all_seeds(f'{t}_mvcnn_NC12_LE10_quant0_dim1_comp',f,12,32)
    losses1 = all_seeds(f'{t}_mvcnn_NC12_LE10_quant4_dim2_compquantize',f,12,2)
    losses2 = all_seeds(f'{t}_mvcnn_NC12_LE10_quant8_dim2_compquantize',f,12,3)
    losses3 = all_seeds(f'{t}_mvcnn_NC12_LE10_quant16_dim2_compquantize',f,12,4)
    ...
    plt.tight_layout()
    plt.savefig(f'{t}_quantcomm_12_mvcnn.png')
    #plt.show()
